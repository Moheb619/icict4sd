    ...
    <section id="hero" className="hero min-h-screen relative bg-[url('/img/intro-bg.jpg')]">
      ...
      <div className="hero-content text-center text-neutral-content">
        <div className="max-w-4xl">
          ...
          <p className={`mb-5 text-5xl text-red-700 font-bold ${styles.text_shadow_hero}`}>
            2<sup>ND</sup> INTERNATIONAL CONFERENCE
          </p>
          <p className="mb-5 text-2xl">ON</p>
          <p className="mb-5 text-3xl">INFORMATION AND COMMUNICATION TECHNOLOGY FOR SUSTAINABLE DEVELOPMENT</p>
          <p className="mb-5 text-2xl">14-16 September, 2023, Bangladesh University of Professionals</p>
